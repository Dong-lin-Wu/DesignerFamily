		...
		<form action="ProductServlet" method="POST" enctype="multipart/form-data">
			<div class="mb-3">
				<label for="commNo" class="form-label">商品編號</label> <input
					...
					value="${productList[param.id].commNo}" readonly>
			</div>
			<div class="mb-3">
				<label for="commTitle" class="form-label">商品標題</label> <input
					type="text" class="form-control" id="commTitle" name="commTitle"
					value="${productList[param.id].commTitle}">
			</div>
			<div class="mb-3">
				<label for="commDES" class="form-label">商品描述</label>
				<textarea class="form-control" id="commDES" name="commDES">${productList[param.id].commDES}</textarea>
			...
			<div class="mb-3">
				<label for="commDES" class="form-label">商品規格</label> <input
					...
					value="${productList[param.id].commSPE}">
			...
			<div class="mb-3">
				<label for="commDES" class="form-label">設計師</label> <input
					...
					value="${productList[param.id].designer}">
			...
			<div class="mb-3">
				<label for="commDES" class="form-label">價格</label> <input
					...
					value="${productList[param.id].commPrice}">
			...
			<div class="mb-3">
				<label for="commDES" class="form-label">數量</label> <input
					...
					name="commQuantity" value="${productList[param.id].commQuantity}">
